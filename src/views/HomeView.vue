...
const photographyWorkGlobs = import.meta.glob(
  '@/assets/photography-work/*.*',
  { eager: true }
)
...
<template>
    ...
    <div id="about">
        ...
        <div class="gap-left-px-1">
            ...
            <p class="text-2 text-level-2 uppercase sub-interactable">&boxvr;&boxh; <span class="hover-fade-1">Sex: <span class="inline-block hover-move-right-2">Female</span></span></p>
        ...
        <div id="favourite" class="gap-left-px-1 gap-top-em-2">
            ...
            <h3 class="flex justify-between align-center gap-left-px-2"><b>喜好</b> <span class="text-3 text-level-4 uppercase">Favourite</span></h3>
