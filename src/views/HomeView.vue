...
<template>
    ...
    <div id="about">
        ...
        <div class="gap-left-px-1">
            ...
            <p class="text-2 text-level-2 uppercase sub-interactable">&boxvr;&boxh; <span class="hover-fade-1">Sex: <span class="inline-block hover-move-right-2">Male</span></span></p>
